...
let element;
let riddle_shown = false;
let answer_shown = false;
let answer;
...
function showMeme() {
  ...
  element.src = getRandomData("memes");
  headings.item(0).insertAdjacentElement("afterEnd", element);
}

function showJoke() {
  clearAll();
  element = document.createElement("p");
  element.innerText = getRandomData("jokes");
  headings.item(1).insertAdjacentElement("afterEnd", element);
}
...
function showQuote() {
  ...
  element = document.createElement("p");
  element.innerText = randomQuote.quote + "\n\n ~ " + randomQuote.author;
  headings.item(2).insertAdjacentElement("afterEnd", element);
}
...
function showRiddle() {
  ...
  element = document.createElement("p");
  element.innerText = randomRiddle.question;
  answer = randomRiddle.answer;
  headings.item(3).insertAdjacentElement("afterEnd", element);
}

function revealAnswers() {
  if (!riddle_shown) {
    alert("No riddle bruh");
